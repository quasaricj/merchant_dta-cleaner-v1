...
class TestAILogic(unittest.TestCase):
    ...
    def test_ai_accepts_valid_match(self, MockApiClient):
        ...
        mock_api_client.analyze_search_results.return_value = ({"cleaned_merchant_name": "Good Mart", "website_candidates": ["http://goodmart.com"], "social_media_candidates": [], "business_status": "Operational", "supporting_evidence": "Official site for Good Mart"}, "prompt")
    ...
    def test_ai_rejects_mismatched_result(self, MockApiClient):
        ...
        mock_api_client.analyze_search_results.return_value = ({"cleaned_merchant_name": "", "website_candidates": [], "social_media_candidates": [], "business_status": "Uncertain", "supporting_evidence": "No direct evidence found in search results."}, "prompt")
