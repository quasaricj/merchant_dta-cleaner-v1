...
from src.core.cost_estimator import API_COSTS, CostEstimator  # Correctly import from the source of truth
...
class TestProcessingEngine(unittest.TestCase):
    ...
    def test_basic_mode_successful_search(self):
        ...
        # Correctly calculate cost using the new estimator logic
