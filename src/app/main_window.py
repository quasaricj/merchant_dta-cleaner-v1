...
from src.core.data_model import JobSettings, ColumnMapping, ApiConfig
...
class MainWindow(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # --- Progress & Job Management Frame ---
        progress_frame = ttk.LabelFrame(main_frame, text="Job Progress", padding="10")
    ...
    def _create_config_widgets(self, parent):
        ...
        controls_frame = ttk.LabelFrame(parent, text="Step 4: Configure and Run", padding="10")
    ...
    def handle_file_selection(self, filepath: str):
        ...
        dummy_mapping = ColumnMapping(merchant_name="<not_mapped>")
        self.job_settings = JobSettings(
            input_filepath=filepath, output_filepath=self._generate_output_path(filepath),
            column_mapping=dummy_mapping, start_row=2, end_row=-1, mode="Basic"
        )
