...
# Import the shareable, non-circular custom exceptions
from src.services.custom_exceptions import MockHttpError429, MockHttpError503, MockQuotaExceededError
